        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="navbar-item">
                    <a href="/items"  style="font-size:20px;" class="nav-link" id="linkid">Products</a>
                    <a href="/items"  style="font-size:20px;" class="nav-link" id="linkid">Purchases</a>
                    <a href="/items"  style="font-size:20px;" class="nav-link" id="linkid">Create Admin</a>
                </li>
            </ul>
        </div>
