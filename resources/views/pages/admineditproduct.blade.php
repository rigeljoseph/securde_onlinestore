                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('item.update', $item->item_id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="item_id" type="text" class="form-control{{ $errors->has('item_id') ? ' is-invalid' : '' }}" name="item_id" value="{{$item->item_id}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{$item->price}}" required autofocus>
